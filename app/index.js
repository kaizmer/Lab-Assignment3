...
const Login = () => {
    ...
    return (
        <View style={loginStyle.container}>
            ...
            <View style={loginStyle.section}> 
                <Button style={{...loginStyle.buttonBox, width: 300, backgroundColor: '#FF6961'}} icon="login" mode="contained-tonal" onPress={() => router.replace("dashboard")}>Login</Button>
                <Button style={{...loginStyle.buttonBox, marginTop: 0, width: 300}}  textColor="#FF6961" mode="text" onPress={() => router.push("register")}>Don't have an account yet?</Button>
                <Button style={{...loginStyle.buttonBox, marginTop: 0, width: 300}}  textColor="#FF6961" mode="text" onPress={() => router.push("passwordreset")}>Forgot Password</Button>
            </View>
